...
<?php include_once "city_reportsmryinfo.php" ?>
<?php
...
$city_report_summary = NULL; // Initialize page object first

class crcity_report_summary extends crcity_report {
	...
	// Page object name
	var $PageObjName = 'city_report_summary';
	...
	function __construct() {
		...
		// Table object (city_report)
		if (!isset($GLOBALS["city_report"])) {
			$GLOBALS["city_report"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["city_report"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'city_report', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fcity_reportsummary";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_city_report\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_city_report',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fcity_reportsummary\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fcity_reportsummary\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fcity_reportsummary\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->LINE->CurrentValue;
			$this->Val[3] = $this->FROM->CurrentValue;
			$this->Val[4] = $this->TO->CurrentValue;
			$this->Val[5] = $this->DESCRIPTION->CurrentValue;
		} else {
			$this->ID->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->LINE->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			$this->Cell_Rendered($this->LINE, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->LINE->Visible) $this->DtlColumnCount += 1;
...
// Create page object
if (!isset($city_report_summary)) $city_report_summary = new crcity_report_summary();
if (isset($Page)) $OldPage = $Page;
$Page = &$city_report_summary;
...
// Create page object
var city_report_summary = new ewr_Page("city_report_summary");

// Page properties
city_report_summary.PageID = "summary"; // Page ID
var EWR_PAGE_ID = city_report_summary.PageID;

// Extend page with Chart_Rendering function
city_report_summary.Chart_Rendering = 
...
city_report_summary.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php include "city_reportsmrypager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<!-- Report grid (begin) -->
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ID"><div class="city_report_ID"><span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ID">
<?php if ($Page->SortUrl($Page->ID) == "") { ?>
		<div class="ewTableHeaderBtn city_report_ID">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer city_report_ID" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ID) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="LINE"><div class="city_report_LINE"><span class="ewTableHeaderCaption"><?php echo $Page->LINE->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="LINE">
<?php if ($Page->SortUrl($Page->LINE) == "") { ?>
		<div class="ewTableHeaderBtn city_report_LINE">
			<span class="ewTableHeaderCaption"><?php echo $Page->LINE->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer city_report_LINE" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->LINE) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->LINE->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->LINE->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->LINE->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="FROM"><div class="city_report_FROM"><span class="ewTableHeaderCaption"><?php echo $Page->FROM->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="FROM">
<?php if ($Page->SortUrl($Page->FROM) == "") { ?>
		<div class="ewTableHeaderBtn city_report_FROM">
			<span class="ewTableHeaderCaption"><?php echo $Page->FROM->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer city_report_FROM" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->FROM) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->FROM->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="TO"><div class="city_report_TO"><span class="ewTableHeaderCaption"><?php echo $Page->TO->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="TO">
<?php if ($Page->SortUrl($Page->TO) == "") { ?>
		<div class="ewTableHeaderBtn city_report_TO">
			<span class="ewTableHeaderCaption"><?php echo $Page->TO->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer city_report_TO" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->TO) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->TO->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="DESCRIPTION"><div class="city_report_DESCRIPTION"><span class="ewTableHeaderCaption"><?php echo $Page->DESCRIPTION->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="DESCRIPTION">
<?php if ($Page->SortUrl($Page->DESCRIPTION) == "") { ?>
		<div class="ewTableHeaderBtn city_report_DESCRIPTION">
			<span class="ewTableHeaderCaption"><?php echo $Page->DESCRIPTION->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer city_report_DESCRIPTION" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->DESCRIPTION) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->DESCRIPTION->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_city_report_ID"<?php echo $Page->ID->ViewAttributes() ?>><?php echo $Page->ID->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->LINE->Visible) { ?>
		<td data-field="LINE"<?php echo $Page->LINE->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_city_report_LINE"<?php echo $Page->LINE->ViewAttributes() ?>><?php echo $Page->LINE->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->FROM->Visible) { ?>
		<td data-field="FROM"<?php echo $Page->FROM->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_city_report_FROM"<?php echo $Page->FROM->ViewAttributes() ?>><?php echo $Page->FROM->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->TO->Visible) { ?>
		<td data-field="TO"<?php echo $Page->TO->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_city_report_TO"<?php echo $Page->TO->ViewAttributes() ?>><?php echo $Page->TO->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->DESCRIPTION->Visible) { ?>
		<td data-field="DESCRIPTION"<?php echo $Page->DESCRIPTION->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_city_report_DESCRIPTION"<?php echo $Page->DESCRIPTION->ViewAttributes() ?>><?php echo $Page->DESCRIPTION->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
