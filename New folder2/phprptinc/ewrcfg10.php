...
define("EWR_PROJECT_ID", "{f2e11bb7-6c58-4902-9e22-305ff94d8ab7}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "nova_airline_db", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'pQFc2dj4nreri0s0', TRUE); // Random key for encryption
